# Kiri: Vastus isikute registri küsimusele

**Kuupäev**: 15. detsember 2025, 17:50  
**Saatja**: Mihkel Putrinš <mitselek@gmail.com>  
**Saaja**: Liisi Ploom  
**Teema**: Re: Person registry täitmise küsimus
...
- 📊 **Täpsustus**: Excel fail on juba sorteeritud entu_field veeru järgi
  - Lihtne filtreerida ainult donator read
...
Liisi täidab ainult donator-välja (804 kirjet).  
Ülejäänud väljad jäävad tühjaks (tuleviku jaoks saadaval, kui RIK mass-kirjeldamine tuleb).
